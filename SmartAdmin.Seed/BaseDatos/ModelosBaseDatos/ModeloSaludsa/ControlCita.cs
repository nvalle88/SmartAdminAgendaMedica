...
namespace  SmartAdmin.Seed.ModelsSaludsa
{
    public partial class ControlCita
    {
        ...
        public bool? PagoSaludsa { get; set; }
        public DateTime? PagoFechaLimite { get; set; }
        public DateTime? PagoFechaParaAnulacion { get; set; }
        public DateTime? PagoFechaCitaEliminada { get; set; }
        public string UrlPago { get; set; }
        public int? CantidadIntentosAnulacion { get; set; }
